	...
	<div class="wrapper">
		...
		<div class="container">
			...
			<div class="content">
				...
				<main id="content" class="campuslife notice-view">
					...
					<article class="board-view">
						<header>
							<h3>온라인복학신청 온라인복학신청 온라인복학신청 온라인복학신청 온라인복학신청 온라인복학신청 온라인복학신청 온라인복학신청 온라인복학신청 온라인복학신청 온라인복학신청</h3>
							<dl>
						...
						<div class="btn-area">
							<div class="row">
								<div class="col-xs-6">
									<a href="#" class="btn btn-default btn-list btn-sm">목록</a>
								</div>
								<div class="col-xs-6">
