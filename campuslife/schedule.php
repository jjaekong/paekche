		...
		<div class="container">
			<div class="aside"> 
				<aside id="aside">
					...
					<nav id="lnb">
						<ul>
							<li class="active"><a href="/campuslife/schedule.php">학사일정</a></li>
			...
			<div class="content">
				...
				<main id="content" class="campuslife schedule">
					<div class="page-header">
						<h2>학사일정</h2>
						<hr>
					</div>
					<section class="month">
						<h3>01<br><small>JANUARY</small></h3>
						<dl>
							<dt>1일</dt>
							<dd>신정</dd>
							<dt>14일</dt>
					...
					<section class="month">
						<h3>02<br><small>FEBRUARY</small></h3>
						<dl>
							<dt>01일 ~ 05일</dt>
							<dd>강의계획서 입력</dd>
							<dt>02일</dt>
							...
							<dd>설날</dd>
							<dt>22일 ~ 26일</dt>
							<dd>2016학년도 1학기 수강신청 기간</dd>
							<dt>29일</dt>
							<dd>제25회 입학식 및 1학기 개강</dd>
						</dl>
						<div class="month-table">
							<table class="day-table">
								<colgroup>
					...
					<section class="month">
						<h3>03<br><small>MARCH</small></h3>
						<dl>
							<dt>29일 ~ 04일</dt>
							<dd>1학기 수강신청 변경 및 정정기간</dd>
							<dt>01일</dt>
							<dd>삼일절</dd>
							<dt>24일</dt>
