...
<body>
	...
	<main id="content" tabindex="-1" class="departments notice">
					...
					<table class="table">
						...
						<tbody>
							...
							<tr>
								...
								<td><img class="jpg-file" src="/departments/images/jpg.png" alt="jpg파일"></td>
								<td>학과사무실</td>
								<td>2015.11.23</td>
								<td>12</td>
							</tr>
							...
							<tr>
								...
								<td><img class="pdf-file" src="/departments/images/pdf.png" alt="pdf파일"></td>
								<td>학과사무실</td>
								<td>2015.10.13</td>
								<td>12</td>
							</tr>
