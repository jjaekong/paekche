...
<header id="header">
    <div class="container">
        <div class="logo">
            <h1><a href="/"><img src="/departments/images/logo.png" alt="백제예술대학교"></a></h1>
            <h2><a href="/departments/main.php"><a href="/departments/main.php">미디어음악과</a></a></h2>
        </div>
            ...
            <ul>
                ...
                <li class="has-child">
                    ...
                    <ul>
                        ...
                        <li><a href="#">학과활동 갤러리</a></li>
                    </ul>
                </li>
                <li><a href="#">학과동영상</a></li>
            </ul>
        </nav>
    </div>
</header>