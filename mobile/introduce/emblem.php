...
<body>
	...
	<main id="content" tabindex="-1" class="introduce emblem">
		<div class="container">
			<div class="page-header">
				<hr />
				<h2>상징소개</h2>
				<p>우리 대학의 <i>교육 목표 체계</i></p>
			</div>
			<section class="didactic">
			...
			<section class="school-song">
				...
				<div class="section-content">
					<div class="btn-area">
						<p>
							<a href="#" class="btn song-btn">교가 듣기</a>
							<a href="#" class="btn sheet-btn">악보 보기</a>
						</p>
					</div>
				</div>
			</section>
