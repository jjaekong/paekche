        ...
        <div class="container">
                ...
                <aside id="aside">
                    ...
                    <nav id="lnb">
                        <ul>
                            ...
                            <li><a href="#">상징소개</a></li>
                            <li class="active"><a href="#">학교조직</a></li>
            ...
            <div class="content">
                <ol class="breadcrumb">
                    ...
                    <li><a href="#">대학소개</a></li>
                    <li class="active">학교조직</li>
                </ol>
                <main id="content" class="introduce group">
					<div class="page-header">
                        <h2>학교조직</h2>
						<hr>
                    </div>
					<section class="in-group">
						<p><img src="/images/introduce/in_group.jpg" alt="조직도"></p>
						<div class="sr-only">
							<h3>총장</h3>
							<ul>
								<li><h4>각종위원회</h4></li>
