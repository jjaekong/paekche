        ...
        <div class="container">
                ...
                <aside id="aside">
                    ...
                    <nav id="lnb">
                        <ul>
                            ...
                            <li><a href="#">학사공지</a></li>
                            <li><a href="#">백제뉴스</a></li>
                            <li class="active"><a href="#">백제스타</a></li>
                            <li><a href="#">보도자료</a></li>
            ...
            <div class="content">
                <ol class="breadcrumb">
                    ...
                    <li><a href="#">백제광장</a></li>
                    <li class="active">백제스타</li>
                </ol>
                <main id="content" class="community star">
                    ...
                    <div class="star-wrap">
                        <div class="star-view" id="star-view">
                            <ul>
                                <li>
                                    <figure>
                                        <img src="/images/community/img_star.jpg" alt="">
                                        <figcaption>
                                            <dl>
                                                <dt>윤손하</dt>
                                                <dd>탤런트</dd>
                            ...
                            <div class="controls">
                                <a class="prev" href="#"><img src="/images/community/ico_arrow_left.png" alt="이전"></a>
                                <a class="next" href="#"><img src="/images/community/ico_arrow_right.png" alt="다음"></a>
                            </div>
                        </div>
                        <div class="star-list">
                            <ul>
                                <li>
                                    <a href="#star-view">
                                        <figure>
                                            <img src="/images/community/img_star_sm.jpg" alt="">
                                            <figcaption>
                                                <dl>
                                                    <dt>백지영</dt>
                                                    <dd>가수</dd>
